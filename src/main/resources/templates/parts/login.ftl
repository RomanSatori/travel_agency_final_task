...
<#macro login path isRegisterForm>
    <form action="${path}" method="post">
        ...
        <#if isRegisterForm>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"><@spring.message "login.password2"/>:</label>
                <div class="col-sm-6">
        ...
        <button class="btn btn-primary" type="submit"><#if isRegisterForm><@spring.message "login.create"/><#else><@spring.message "login.sign-in"/></#if></button>
    </form>
</#macro>
